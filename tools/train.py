...
from instancevg.core import build_optimizer, build_scheduler
from instancevg.datasets import build_dataset, build_dataloader
from instancevg.models import build_model, ExponentialMovingAverage
from instancevg.apis import set_random_seed, train_model, evaluate_model
from instancevg.utils import (
    get_root_logger,
    load_checkpoint,
    save_checkpoint,
...
def main_worker(cfg):
    ...
    if is_main():
        ...
        wandb.init(project="instancevg-offline", tags=[cfg.tag_name], name=cfg.wandb_name, mode="offline")
